...
Since Feb. 2023, off2 uses [Proxmox](../explanation/proxmox.md).
...
We also have 213.36.253.214 which is dedicated to the [NGINX reverse proxmox](../explanation/nginx-reverse-proxy.md).
