...
Main web server is hosted on off1 and off2 at [Free Datacenter](../reference/free-datacenter.md)
...
We use [sanoid](./software/sanoid.md) to manage snapshot (create them and handle retention policy).

We use [syncoid](./software/sanoid.md#syncoid-service-and-configuration), a companion tool of sanoid to synchronize snapshots on other servers.
