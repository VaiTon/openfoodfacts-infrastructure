...
- [free.org](https://www.fondation-free.fr/) is sponsoring us electricity, network and server hosting.
  ...
  see [Free Datacenter](../reference/free-datacenter.md)
...
- [OVH foundation](https://www.ovhcloud.com/) sponsors us three bare metal servers:
  ...
  See [OVH Servers](../reference/ovh-servers.md)

- [Moji](https://moji.fr/) is also sponsoring us a good server

We also have some paid servers:
- ks1.openfoodfacts.org at [Kimsufi](../reference/ovh-servers.md)
- some servers at [Hetzner](../reference/hetzner-servers.md) (should be temporary)
...
- Most services are hosted on ovh,
  and pass through an nginx proxy (see [proxmox - HTTP Reverse Proxy](../explanation/proxmox.md#http-reverse-proxy))
...
Uses [proxmox](../explanation/proxmox.md)

Part of [proxmox](../explanation/proxmox.md) cluster.
...
Located at Moji. See [Moji Datacenter](../reference/moji-datacenter.md)
