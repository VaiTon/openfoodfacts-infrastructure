...
It is deployed on the docker-prod-2 vm (vm 200) on [moji server (aka osm45)](../../reference/moji-datacenter.md), using docker-compose.

It relies on the [stunnel](../software/stunnel.md) to join other services.
