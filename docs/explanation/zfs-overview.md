...
In [Munin](./software/munin.md) `ZFS ARC - Hit ratio`  the `ZFS Arc Efficiency` gives you an idea of how well ZFS caching is performing.
...
We normally do it using [sanoid and syncoid](./software/sanoid.md)
